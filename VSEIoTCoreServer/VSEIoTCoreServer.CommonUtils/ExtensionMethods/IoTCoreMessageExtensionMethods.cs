...
namespace VSEIoTCoreServer.CommonUtils.ExtensionMethods
{
    using System.Linq;
    ...
    public static class IoTCoreMessageExtensionMethods
    {
        ...
        {
            if (objectData == null || objectData["value"] == null || objectData["value"].ToList().Count < 1)
            {
                return null;
            }
        ...
        {
            if (objectData == null || objectData["value"] == null)
            {
                return null;
            }
